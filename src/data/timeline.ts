...
export const timelineData: TimelineItem[] = [
  ...
  },
  {
    ...
    description: "Engaged in a virtual internship focusing on coding challenges, real-world projects, and industry-relevant practices using technologies like JavaScript, ReactJS, and Node.js.",
    icon: "work",
  },
  {
    year: "2022-2025",
  ...
  },
  {
    ...
    company: "Dronacharya College of Engineering, Agra",
    description: "Completed my Diploma in Computer Science Engineering, laying the foundation for my journey in software development and problem-solving.",
    icon: "education",
  },
  {
    year: "2023 - 2025",
